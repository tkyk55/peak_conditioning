...
urlpatterns = [
    ...
    path('staff/booking/input/<int:training_id>/<int:booking_id>/<int:year>/<int:month>/<int:day>/<int:hour>/<int:minute>/', app_staff_views.StaffBookingInputView.as_view(), name='staff_booking_input'),
    path('staff/booking/input/<int:training_id>/<int:booking_id>/<int:user_id>/<int:err_cd>/<int:year>/<int:month>/<int:day>/<int:hour>/<int:minute>/', app_staff_views.StaffBookingInputView.as_view(), name='staff_booking_input'),
    path('staff/booking/input/search/<int:training_id>/<int:year>/<int:month>/<int:day>/<int:hour>/<int:minute>/', app_staff_views.StaffBookingInputSearchView.as_view(), name='staff_booking_input_search'),
    ...
    path('ex_reserve/ex_calendar/<int:pk>/', app_member_views.ExCalendarView.as_view(), name='ex_calendar'),
    path('ex_reserve/ex_calendar/<int:pk>/<int:year>/<int:month>/<int:day>/', app_member_views.ExCalendarView.as_view(), name='ex_calendar'),
    path('ex_reserve/booking/<int:pk>/<int:year>/<int:month>/<int:day>/<int:hour>/', app_member_views.ExBookingView.as_view(), name='ex_booking'),
